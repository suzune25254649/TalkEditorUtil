...
# このツールが解決する「面倒ごと」
* 琴葉葵と、鳴花ミコトと、IAと、六花と、ゆっくり霊夢が会話する動画を作りたいのに、トークソフトを5種類も操作しなくちゃいけなくて面倒。
...
"編集：talkers.bat"を起動して設定してください。  
書き方は設定ファイルに書いてあります。

サンプルとして記述されているもの以外に足したい場合、編集してください。

# 終末ポーズの設定
"編集：addsilence.bat"を起動して設定してください。  
書き方は設定ファイルに書いてあります。
...
ただし、このツールを利用した際に発生した いかなる損失や損害が発生について、作者は一切の責任を負いかねます。
